...
const ExtraSection = () => {
    return (
        <div className='bg-base-200'>
             <div  className='max-w-7xl w-11/13 mx-auto pt-30 pb-20'>
             ...
             <div className='text-[#808080] max-w-7xl w-11/13 mx-auto'>
             ...
             <div className='mx-auto max-w-7xl w-11/13 mt-5 text-[#808080] pb-20'>
